...
int main(int argc, char *argv[])
{
     ...
     printf("n,j,RT_j,gaps,steps,μs,r1,c1,p1,r2,c2,p2,r3,c3,p3,r4,c4,p4,r5,c5,p5,r6,c6,p6,r7,c7,p7,r8,c8,p8\n");
     int j;
     for (j = n-1; j >= 0; j--)
     {
	  size_t comp_steps = 0;
	  ...
	  printf("%lu,%d,%ld,%lu,%lu,%lu,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld,%ld\n",
		 n, j+1, rt_j, gap_ct, comp_steps, t_exec,
